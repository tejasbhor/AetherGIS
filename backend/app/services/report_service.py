  ...
  <div class="container">
    ...
    <div class="report-header">
      ...
      <div class="report-meta">
        ...
        <span><span class="meta-label">Generated:</span> {html.escape(str(now))}</span>
      </div>
    </div>
      ...
      <div class="section">
        ...
        <div class="exec-summary">
          ...
          <p>
            ...
            {" Execution completed with errors." if error_msg else f" Execution completed successfully in {html.escape(str(duration))}."}
          </p>
        </div>
      ...
      <div class="section">
        ...
        <div class="info-grid">
          ...
          <div class="info-row">
            ...
            <div class="info-value">{html.escape(str(_format_datetime(created_at)))}</div>
          </div>
          <div class="info-row">
            <div class="info-label">Completed At</div>
            <div class="info-value">{html.escape(str(_format_datetime(completed_at)))}</div>
          </div>
          <div class="info-row">
            <div class="info-label">Duration</div>
            <div class="info-value">{html.escape(str(duration))}</div>
          </div>
          <div class="info-row">
            <div class="info-label">Report Generated</div>
            <div class="info-value">{html.escape(str(now))}</div>
          </div>
        </div>
      ...
      <div class="section">
        ...
        <div class="info-grid">
          <div class="info-row">
            ...
            <div class="info-value">{html.escape(str(_format_datetime(time_start)))}</div>
          </div>
          <div class="info-row">
            <div class="info-label">End Time</div>
            <div class="info-value">{html.escape(str(_format_datetime(time_end)))}</div>
          </div>
        </div>
    ...
    <div class="report-footer">
      ...
      <div class="footer-meta">
        ...
        <span>Generated: {html.escape(str(now))}</span>
      </div>
    </div>
