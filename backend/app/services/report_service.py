      ...
      <div class="section">
        ...
        <div class="info-grid">
          ...
          <div class="info-row">
            ...
            <div class="info-value">{html.escape(_format_datetime(created_at))}</div>
          </div>
          <div class="info-row">
            <div class="info-label">Completed At</div>
            <div class="info-value">{html.escape(_format_datetime(completed_at))}</div>
          </div>
          <div class="info-row">
      ...
      <div class="section">
        ...
        <div class="info-grid">
          <div class="info-row">
            ...
            <div class="info-value">{html.escape(_format_datetime(time_start))}</div>
          </div>
          <div class="info-row">
            <div class="info-label">End Time</div>
            <div class="info-value">{html.escape(_format_datetime(time_end))}</div>
          </div>
        </div>
