...
def generate_html_report(
    ...
    # Job metadata
    job_id_esc = html.escape(str(job_id))
    ...
    error_msg = html.escape(str(pipeline_result.get("error"))) if pipeline_result.get("error") else None
...
<head>
  ...
  <title>AetherGIS Technical Report — {job_id_esc[:12]}</title>
  ...
  <div class="container">
    ...
    <div class="report-header">
      ...
      <div class="report-meta">
        <span><span class="meta-label">Job ID:</span> {job_id_esc}</span>
    ...
    <div class="content">
      ...
      <div class="section">
        ...
        <div class="info-grid">
          <div class="info-row">
            ...
            <div class="info-value">{job_id_esc}</div>
          </div>
          <div class="info-row">
      ...
      <div class="section">
        ...
        <ul class="artifact-list">
          <li>
            <span class="artifact-path">/exports/{job_id_esc}/original.mp4</span>
            <span class="artifact-desc">Original observed frame sequence (no interpolation)</span>
          </li>
          <li>
            <span class="artifact-path">/exports/{job_id_esc}/interpolated.mp4</span>
        ...
        <ul class="artifact-list">
          <li>
            <span class="artifact-path">/exports/{job_id_esc}/frames/frame_*.png</span>
        ...
        <ul class="artifact-list">
          <li>
            <span class="artifact-path">/exports/{job_id_esc}/metadata.json</span>
            <span class="artifact-desc">Complete frame metadata with per-frame metrics</span>
          </li>
          <li>
            <span class="artifact-path">/exports/{job_id_esc}/report.html</span>
      ...
      <div class="section">
        ...
        <p style="font-size: 11px; color: var(--t3); line-height: 1.6;">
          ...
          are computed from the actual execution artifacts stored at <code>/exports/{job_id_esc}/</code>.
    ...
    <div class="report-footer">
      <div class="footer-section">
        ...
        <p class="footer-text">
          ...
          <strong>Report ID:</strong> RPT-{job_id_esc[:12]}-{datetime.utcnow().strftime('%Y%m%d')}
        </p>
      </div>
      
      <div class="footer-meta">
        <span>AetherGIS Technical Report</span>
        <span>Job: {job_id_esc[:16]}</span>
