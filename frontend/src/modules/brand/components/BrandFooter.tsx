...
const SocialIconGithub = (props: React.SVGProps<SVGSVGElement>) => (
...
const SocialIconBrandX = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" {...props} fill="currentColor">
    <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z" />
  </svg>
);

const SocialIconDiscord = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" {...props} fill="currentColor">
...
const SocialIconBluesky = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" {...props} fill="currentColor">
...
const SocialIconLinkedIn = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" {...props} fill="currentColor">
                ...
                return (
                  ...
                  >
                    <IconComponent 
                      ...
                      aria-hidden="true"
                    />
                    <span className="brand-footer-social-label" aria-hidden="true">
                      {social.label}
                    </span>
                  </a>
                );
          ...
          <div className="brand-footer-column brand-footer-newsletter">
            ...
            <form className="brand-footer-form" onSubmit={(e) => e.preventDefault()}>
              <div className="brand-footer-input-wrap">
                ...
                />
                <button type="submit" className="brand-btn brand-btn-primary brand-btn-sm brand-footer-submit">
                  Subscribe
                </button>
              </div>
            </form>
